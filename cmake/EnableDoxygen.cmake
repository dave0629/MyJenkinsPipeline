if(AUDIENCE_BUILD_DOXYGEN)
    # Find out the name of the subproject.
    get_filename_component(AUDIENCE_MODULE_SUBPROJECT "${CMAKE_CURRENT_SOURCE_DIR}" NAME)
    ...
    if (${CMAKE_VERSION} VERSION_LESS "3.9")
        ...
        if (Doxygen_FOUND)
            ...
            doxygen_add_docs(
                ${AUDIENCE_MODULE_SUBPROJECT}-docs ${CMAKE_CURRENT_SOURCE_DIR}
                WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} 
                COMMENT "Generate HTML documentation")
            add_dependencies(doxygen-docs ${AUDIENCE_MODULE_SUBPROJECT}-docs)
